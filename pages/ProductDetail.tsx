        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-none text-navy dark:text-white">
                {product.name}
              </h1>
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-baseline gap-2">
                <span className="text-6xl lg:text-7xl font-black tracking-tighter text-navy dark:text-white">
