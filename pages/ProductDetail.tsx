          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-4">
                {product.sku && (
                  <p className="text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-gray-400">
                    referência: <span className="text-gray-600 dark:text-gray-300 ml-1">{product.sku}</span>
                  </p>
                )}
                {product.stock <= 5 && product.stock > 0 && (
                  <span className="text-[9px] font-black uppercase tracking-widest text-red-500 bg-red-500/10 px-2 py-0.5 rounded-full">
                    Poucas unidades!
                  </span>
                )}
              </div>
