  ...
  return (
    <div className="p-4 md:p-8 lg:p-12 max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-10">
        <Link to="/admin/categorias" className="size-12 bg-white dark:bg-[#0d1840] rounded-2xl flex items-center justify-center hover:bg-primary transition-all shadow-sm group">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 flex flex-col gap-8">
          <div className="bg-white dark:bg-[#0d1840] p-6 lg:p-8 rounded-2xl lg:rounded-[2.5rem] border border-gray-100 dark:border-[#222115] shadow-sm">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="bg-gray-50 dark:bg-[#08112e] border-none p-4 rounded-xl text-sm font-bold focus:ring-2 focus:ring-primary outline-none transition-all"
                />
              </div>
