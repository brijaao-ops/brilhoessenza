  ...
  return (
    <div className="p-4 md:p-8 lg:p-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 lg:mb-12">
        <div>
          <h2 className="text-2xl lg:text-3xl font-black uppercase tracking-tighter">Gestão de <span className="text-primary italic">Envios</span></h2>
          <p className="text-[11px] lg:text-sm text-gray-500 font-medium">Rastreamento de encomendas e parceiros logísticos.</p>
        </div>
      </div>
