...
const ProductCard: React.FC<ProductCardProps> = ({ product, onAddToCart }) => {
    ...
    return (
        <div className="relative flex flex-col justify-between h-[420px] sm:h-[450px] w-full bg-white rounded-[2.5rem] sm:rounded-[30px] overflow-hidden group shadow-lg border border-gray-100 dark:border-white/5 transition-all duration-500 hover:shadow-2xl hover:scale-[1.01]">
            {/* The Invisible Global Link - MUST BE ON TOP of everything except the cart button */}
            <Link
            ...
            {/* Header: Category/Signature & Stock - Z-50 (above link) but pointer-events-none */}
            <div className="absolute top-0 left-0 w-full flex justify-between items-center p-4 sm:p-6 z-50 pointer-events-none">
            ...
            {/* Image Container - Z-20 (below link) */}
            <div className="flex-1 relative flex items-center justify-center p-4 sm:p-6 transition-transform duration-700 z-20 pointer-events-none">
            ...
            {/* Quick Add Button - Z-60 (ABOVE EVERYTHING) */}
            {product.stock > 0 && (
                <button
