...
const ProductDetail: React.FC<ProductDetailProps> = ({ onAddToCart, products }) => {
  ...
  if (!product) return (
    <div className="py-48 text-center animate-fade-up">
      <h2 className="text-3xl font-black uppercase tracking-tighter">Tesouro n├úo encontrado.</h2>
  ...
  return (
    <div className="pb-32 animate-fade-up px-4 md:px-0">
        ...
        <div className="flex flex-col gap-8 sm:gap-12 pt-0 sm:pt-4">
          <div className="flex flex-col gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
              ...
              <span className="text-gray-300 dark:text-white/20 text-[10px] uppercase font-black tracking-widest sm:inline hidden">ÔÇó</span>
          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <h4 className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-[#1c1a0d] dark:text-white">A Ess├¬ncia</h4>
      ...
      <div className="mt-24 sm:mt-40 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] sm:rounded-[4rem] p-8 sm:p-16 lg:p-24 text-center border border-gray-200 dark:border-white/5">
        ...
        <Link to="/" className="px-12 py-5 bg-[#1c1a0d] dark:bg-white text-white dark:text-black rounded-2xl text-[11px] font-black uppercase tracking-widest hover:scale-105 transition-all shadow-2xl">Ver Cole├º├úo Completa</Link>
      </div>
    </div>
  );
};
